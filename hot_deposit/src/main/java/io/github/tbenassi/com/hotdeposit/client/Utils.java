...
import io.github.tbenassi.com.hotdeposit.client.mixin.HorseScreenAccessor;
...
public class Utils {
    ...
    public static boolean isContainerScreen(Screen screen) {
        if (!(screen instanceof HandledScreen<?>))
            return false;
        if (screen instanceof ShulkerBoxScreen || screen instanceof GenericContainerScreen) {
            return true;
